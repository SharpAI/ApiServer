...
CREATE TABLE `InsertionOrderLineItemPreview` (
  ...
  `WentLiveDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `auth_Users` (
  ...
  `user_agreement_acceptance_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `DemandCustomerInfo` (
  ...
  `DateCreditApplicationWasSent` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `DateCreated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `DateUpdated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- ----------------------------
INSERT INTO `DemandCustomerInfo` VALUES ('18', 'Larry Brin', 'larry.brin@suckmedianow.com', 'suckmedianow.com', 'Suck Media Now', '1', '0', '0', '0', '2014-09-03 21:32:24', '2014-09-03 21:32:24', '2014-09-03 21:32:24');
