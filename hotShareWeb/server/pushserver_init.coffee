...
if Meteor.isServer
  Meteor.startup ()->
    ...
    apnsProductionCert = Assets.getText 'ios/apn-production/WorkAI_PN_Production_Cert.pem'
    apnsProductionKey = Assets.getText 'ios/apn-production/WorkAI_PN_Production_Key.pem'
    optionsProduction =
        passphrase: '123456'
