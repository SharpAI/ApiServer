...
jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore keystore ".meteor/local/cordova-build/platforms/android/build/outputs/apk/android-armv7-release-unsigned.apk" 'wifi whiteboard'
mv .meteor/local/cordova-build/platforms/android/build/outputs/apk/android-armv7-release-unsigned.apk ./hotShareRelease.apk
